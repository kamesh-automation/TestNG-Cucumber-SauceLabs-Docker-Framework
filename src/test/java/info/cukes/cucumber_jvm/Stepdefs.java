...
public class Stepdefs {
    ...
    public void the_user_opened_browser(String arg1) {
        service = new ChromeDriverService.Builder().usingChromeDriverExecutable(new File("C:\\Users\\kames\\Downloads\\chromedriver_win32\\chromedriver.exe")).usingAnyFreePort().build();
        try {
            service.start();
        } catch (IOException e) {
            e.printStackTrace();
        }
        System.setProperty("webdriver.chrome.driver", "C:/Users/kames/Downloads/chromedriver.exe");
